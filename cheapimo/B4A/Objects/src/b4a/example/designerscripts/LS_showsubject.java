...
views.get("scrollview1").vw.setLeft((int)((1d / 100 * width)));
views.get("scrollview1").vw.setWidth((int)((99d / 100 * width) - ((1d / 100 * width))));
views.get("scrollview1").vw.setTop((int)((1d / 100 * height)));
views.get("scrollview1").vw.setHeight((int)((92d / 100 * height) - ((1d / 100 * height))));
