...
__c.LogImpl("96553612","#SupportedOrientations attribute must be set to landscape or portrait.",_xui.Color_Red);
 };
 };
 }
};
...
__c.LogImpl("96488089","Call B4XPages.GetManager.LogEvents = True to enable logging B4XPages events.",0);
